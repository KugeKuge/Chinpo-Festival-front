    ...
    <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="relative flex items-center justify-between">
        <div className="flex items-center">
          ...
          {/* ロゴ */}
          <Link to="/">
            <img className="inline-flex items-center mr-8" src={logoImage} width="160" height="75"/>
          </Link>

          {/* メニュー */}
          <ul className="flex items-center hidden space-x-8 lg:flex">
            <li>
              <Link to="/" className="text-gray-600 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">入口へ</Link>
            </li>
            <li>
              <Link to="/ChinpoTweet" className="text-gray-600 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">俺とお前のちんぽついーと</Link>
            </li>
            <li>
              <Link to="/ChinpoFace" className="text-gray-600 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">お前の顔面は所詮陰茎</Link>
            </li>
          </ul>
        </div>
